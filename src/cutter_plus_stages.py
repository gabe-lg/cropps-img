...
tk.Label(root, text="Control Panel", font=("Arial", 20), fg="white", bg="#1e1e1e").pack(pady=10)
...
# ---------- Servo Controls ----------
tk.Label(root, text="Servo Down Angle", font=("Arial", 12), fg="white", bg="#1e1e1e").pack()
down_slider = tk.Scale(root, from_=0, to=180, orient="horizontal", length=300, bg="#1e1e1e", fg="white")
down_slider.set(30)
down_slider.pack(pady=5)

tk.Label(root, text="Servo Up Angle", font=("Arial", 12), fg="white", bg="#1e1e1e").pack()
...
tk.Button(root, text="✂️ Execute Cut", command=send_cut, bg="#FF5555", fg="white").pack(pady=10)
